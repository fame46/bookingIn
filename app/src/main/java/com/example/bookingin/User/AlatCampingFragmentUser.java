...
public class AlatCampingFragmentUser extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_alat_camping_user, container, false);
...
//                            Toast.makeText(getContext(), ""+String.valueOf(menuModel.getHarga()), Toast.LENGTH_SHORT).show();
    ...
    private void loadData() {
        ...
        progressDialog.show();
        menuModelList.clear();
        StringRequest jsonObjectRequest = new StringRequest(Request.Method.GET, URLs.GETALATCAMPING, new Response.Listener<String>() {
            @Override
