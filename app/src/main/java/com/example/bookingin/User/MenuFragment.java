...
import com.example.bookingin.Adapter.ViewPagerAdapterUser;
...
public class MenuFragment extends Fragment implements TabLayout.BaseOnTabSelectedListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewPagerAdapterUser adapter = new ViewPagerAdapterUser(getActivity().getSupportFragmentManager(), tabLayout.getTabCount());
